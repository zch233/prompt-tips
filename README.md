...
```markdown
请帮我撰写一份吸引人的知乎文案，用于发布在知乎平台上。这份文案应该包含引人入胜的标题，清晰明了的问题陈述或主题介绍，以及吸引读者阅读的内容概述。文案的风格可以是幽默、启发性、有趣或深入探讨，旨在引起读者的兴趣，激发他们的思考，并促进互动和讨论。
---
[这份知乎文案的主题是什么？]
[您希望文案的风格更偏向于幽默、启发性、有趣还是深入探讨？]
[知乎社区对于互动和讨论有着独特的特点，鼓励他们参与讨论和评论？]
```
...
```markdown
请帮我撰写一份生动有趣的带货视频口播稿，用于在直播或录播带货视频中使用。这份口播稿应包含对产品的介绍、特点和优势的描述，同时要能吸引观众的注意力，增加购买欲望。口播稿应简洁明了，情感真挚，能够有效地促进产品销售，并与观众建立良好的互动和共鸣。

[这份口播稿将用于带货视频中的哪种产品或品类？是否有特定的产品特点或优势需要在口播稿中重点强调？]
[是否有一些具体的数据或用户评价可以用来支持产品的优势和效果？]
[您希望这份口播稿的情感色彩更加突出，还是更加注重产品的功能和实用性？是否需要特别强调与观众建立互动和共鸣的方式和技巧？]
```
...
```markdown
请帮我打造一个吸引人的美妆种草文案，激发读者对特定美妆产品的购买欲望。这篇文案将专注于某款具有独特功能、出色效果或独特设计的美妆产品，向读者展示使用该产品所带来的美丽变化，鼓励他们尝试并亲身体验这款令人心动的美妆产品。产品名称是[纪梵希四色散粉]，类型是[彩妆、护肤、香水]，他的独特[效果/成分/技术特点是]，需要突出介绍它的[实用性和效果/奢华和美感]
```
...
```markdown
请帮我创作一个引人入胜的小红书美食探店文案，让读者感受到探索美食的乐趣和美味。这篇文案将介绍一家特色餐厅或美食街的独特菜品、舒适氛围以及令人难忘的用餐体验，鼓励读者去亲自品尝这些美味佳肴，并在探店的过程中发现惊喜与美食的完美结合。这家美食餐厅或美食街位于[杭州未来 park 老尾猪脚饭]，店内有[招牌猪脚饭、烧腊饭]等特色菜品，具有特色的[味道和口感/体验和氛围]
```
...
```markdown
请帮我设计一个吸引人的景点打卡文案，让游客在社交媒体上分享他们在该景点留下美好回忆的瞬间。这个文案应该能够突出景点的独特之处，吸引读者想要前往亲自体验，并在短短几句话内展现出景点的魅力和吸引力。这个景点名为[杭州西湖]，在[中国浙江杭州]，他的特点是[xxx]，希望这个文案[更加浪漫/梦幻/冒险/轻松/幽默/亲切]
```
...
```markdown
你现在是资深的小红书运营专家，拥有上百万粉丝，请帮我创造一个吸引人的小红书爆款笔记标题。这篇笔记为[探索一些时尚、美容或生活方面的独特而实用]的内容，让读者对内容产生浓厚兴趣，吸引更多的阅读和分享。
```
...
```markdown
请为我的 [bilibili] 频道推荐 10 个关于 [每周健身餐] 的独特视频创意
```
...
```markdown
请对输入的电影名[电影]，分成 3 部分进行解说，要求包含电影最精彩的部分。
```
...
```markdown
请以小红书博文的风格写一篇[主题]推荐，要求使用emjio增加趣味性
```
...
```markdown
给我[微博条数]个微博帖子的想法，以提高对[产品名称]的兴趣。保持这些想法的吸引力和信息量。
...
```markdown
我现在需要准备一个[30字]的朋友圈文案，主题是[新年到来]，帮忙生成[小清晰风格]的发圈文案。
```
...
```markdown
假设你是一个短视频创造新手，现在需要创造一个[喜庆欢快]风格的短视频，视频时间[30秒],短视频的主题是[团队新年拜年]，我的拍摄脚本和运镜安排应该是什么样的？
```
...
```markdown
你是一名直播带货主持人，我希望写一篇直播带货的主持人口播，
包含产品介绍[产品名称]、互动环节[输入环节]、购买链接[地址]
等方面的内容，语气应该[{自然、流畅、有趣}]
```
...
```markdown
扮演一位带货主播的角色，我会提供一个产品名称及其主要特点。请根据此信息，为主播策划一个吸引观众购买的话术大纲，确保以下要素得到体现： 1) 强调产品的独特卖点； 2) 与观众建立情感联系； 3) 创造紧迫感促使观众立即购买； 4) 提供实际使用场景和案例。 请务必将结果呈现得具体、简洁且具有说服力。 回复“OK”以确认，我将提供产品信息。
```
...
```markdown
扮演一位探店达人，根据我提供的探店信息，比如店铺名称、商品、特色等。为我创作一篇具有吸引力的探店笔记，包括以下要点：1) 探店地点的历史背景与文化特色；2) 推荐的菜品、商品或服务；3) 店内环境与设计风格；4) 与店主或员工的互动体验；5) 提供独家优惠或活动信息；6) 适合各类人群的消费场景。请确保结果内容丰富、有趣且具有吸引力，激发读者的好奇心和参与度。 回复“OK”以确认，我将提供探店信息。
```
...
```markdown
我希望通过[持续天数]的定制学习计划来提升我的[目标技能]，作为一个初学者，我希望你能帮我制定一个个性化的学习路线，以帮助我有效地掌握这项技能。在这个学习计划中，包括具体的学习目标、每日的学习任务、适用的学习资源以及评估进展的方式。请在下面的回答中提供详细的指导和建议，使我能够在这段时间内取得最佳的学习效果。
```
...
```markdown
讲[知识主题或技能]分解为更小的单元，并提供一个结构化的学习计划来掌握每个部分
```
...
```markdown
我目前正在学习[学习内容]，为我提供它的不同难度级别的测验或测试，以增强我的记忆力和理解力。
```
...
```markdown
我希望你能充当同义词提供者的角色。我会告诉你一个单词，然后你会根据我的提示向我回复一个同义词替代列表。每个提示提供最多10个同义词。如果我需要更多提供的单词的同义词，我会回复句子：“更多x”，其中x是你查找同义词的单词。你只需回复单词列表，不要写解释。单词应存在。确认回复“OK”。
```
...
```markdown
请帮我撰写一份暑假周记，用于记录每周的暑假生活和所经历的事情。这份周记应包括每周的日期和时间范围，以及对每周的活动、旅行、学习和感受的详细描述。周记的写作可以是自由的，可以包含对所经历事件的心情、感悟和反思，也可以加入一些有趣的插曲或趣事。周记的写作应流畅自然，真实地反映你的暑假生活和感受。

[这份暑假周记的写作范围是从什么时候到什么时候？每周的日期和时间范围应如何确定？]
[在每周的活动、旅行和学习方面，是否有特定的事件或经历需要在周记中详细描述？]
[您希望这份暑假周记更加突出个人感受和反思，还是更加注重对每周活动和事件的生动描写？是否需要特别强调个人成长和收获的体现？]
```
...
```markdown
请帮我撰写一份教学课件，用于教授特定学科或主题的知识。这份教学课件应包括课程的目标和重点，教学内容和知识点的展示，教学方法和教学辅助工具的使用，以及课堂练习和互动环节的设计。课件应结构清晰，图文并茂，能够生动有趣地呈现知识，提高学生的学习效果和学习兴趣。

[这份教学课件所涵盖的学科或主题是什么？教学的目标和重点是什么？是否需要在课件中强调特定的重点内容或难点？]
[教学方法和教学辅助工具的使用方面，是否有特定的教学技巧或教学资源需要在课件中详细描述？]
[您希望这份教学课件更加突出生动有趣的呈现方式，还是更加注重对知识点的深入解释和学习效果的提升？是否需要特别强调互动环节和学生参与的方式和技巧？]
```
...
```markdown
请帮我推荐几篇与特定研究课题相关的优质文献，以帮助我深入了解该领域的相关研究和最新进展。这些文献应该是学术权威的，有较高的引用量和影响力，能够为我的研究提供有价值的参考和支持。

[这个特定研究课题的具体方向和内容是什么？您对文献的需求是否有特定的要求，例如特定的时间范围、研究方法或理论框架？]
[是否有一些特定的学术期刊、会议论文集或专业数据库需要优先考虑，以寻找高质量的相关文献？]
[您希望文献推荐中提供的文献摘要和重要观点有何特别要求？是否需要特别强调文献对您研究的价值和启发？]
```
...
```markdown
请帮我撰写一份完整的论文大纲，用于规划论文的结构和内容。论文大纲应包括引言部分、研究背景和目的、文献综述、研究方法、实验设计、数据分析、结果与讨论、结论和参考文献等部分。大纲应结构清晰、逻辑严谨，能够合理展示论文的组织和内容安排，并指导后续论文的写作和研究实施。

[这份论文大纲的研究课题是什么？论文的研究背景和目的是什么？是否需要提供相关领域的理论基础和文献综述？]
[在论文的方法和实验设计部分，是否有特定的研究方法、数据收集方式或实验流程需要在大纲中详细描述？]
[您希望这份论文大纲更加突出论文的创新性和研究成果，还是更加注重各个部分的逻辑关系和论证流程？是否需要特别强调每个部分的重要性和贡献？]
```
...
```markdown
请帮我撰写一份精炼的论文摘要，用于概括论文的主要内容和研究成果。摘要应包括论文的研究目的、方法和主要结论，突出论文的创新点和贡献。摘要应简洁明了，语言精准，能够吸引读者的兴趣，并让读者对论文产生浓厚的阅读欲望。

[这份论文摘要的论文研究领域和主题是什么？研究的背景和目的是什么？是否需要提供相关领域的理论基础和文献支持？]
[在论文的方法和实验设计方面，是否有特定的研究方法、数据收集方式或实验流程需要在摘要中详细描述？]
[您希望这份论文摘要更加突出论文的创新性和研究成果，还是更加注重论文的研究意义和未来发展的展望？是否需要特别强调论文的重要性和应用价值？]
```
...
```markdown
请帮我撰写一份论文开题报告，用于介绍研究课题的背景、意义和研究目的。开题报告应包括研究问题和研究方法的阐述，相关理论框架和文献综述的梳理，以及初步研究计划和进度安排。报告应结构清晰、逻辑严密，能够说明研究课题的研究意义和价值，并展示合理的研究设计和计划。

[这份论文开题报告的研究课题是什么？研究的背景和意义是什么？是否需要提供相关领域的理论基础和文献支持？]
[在研究方法和数据收集方面，是否有特定的实验设计、调查问卷或文献分析需要在报告中详细描述？]
[您希望这份论文开题报告更加突出研究课题的创新性和实际应用，还是更加注重研究计划和进度的安排？是否需要特别强调研究课题的贡献和意义？]
```
...
```markdown
根据输入的内容，返回[请选择几首{一首，三首，五首}]包含该内容的诗词
...
```markdown
你现在是网红“张雪峰”，请根据输入的专业和大学，以专业就业为目的，结合自身家庭经济条件，帮忙分析我是否值得报考该专业。你需要：
1. 告诉大家你是网红导师“张雪峰”，并模仿他说话的方式做出回复，要求幽默风趣，说话直击要害；
2. 结合“张雪峰”已经分析过的专业报考案例和经验，直接告诉我该专业毕业后是否好找到工作；
3. 该专业毕业后，找到的工作如何，举例说明：如就业竞争度，薪资，福利，社会地位等；
3. 最后，给出你的建议，是否要报考该专业。

请输入你要报考的专业名称“[专业]” ，你要报考的大学“[大学]”，你的家庭条件[{贫困，一般，良好，富裕}]。
```
...
```markdown
请针对喜欢[模型和自然]的同学，给出大学专业选择的建议
```

📅 艾宾浩斯遗忘曲线

记忆利器，温故知新，遗忘曲线助您牢记所学！

```markdown
我最近正在学习[某个知识/技能]，请结合艾宾浩斯遗忘曲线帮我制定学习计划，让我能够更长时间掌握这个技能
```
...
```markdown
结合番茄工作法，帮我安排一个由浅入深地学习计划，这次学习的主题是[学习主题]。
```
...
```markdown
为[主题或技能]建议各种学习资源（例如视频、书籍、博客、互动练习），以迎合不同的学习风格
```
...
```markdown
请借助费曼学习法，以简单的语言解释 [特定概念] 是什么，并提供一个例子来说明它如何应用
```
...
```markdown
为一篇题为[某个主题]的 [800] 字文章产生大纲。内容包括前言、主段落和结论。请确保包括有关该主题的主要观点和论点。
```
...
```markdown
将以下内容改写成[请选择你需要的风格{专业,口语,文艺,幽默,讽刺,严肃,温馨}]的风格
[请输入你需要改写的内容]
```
...
```markdown
判断以下文本是否存在拼写错误或者语法错误。如有错误，输出正确的文本。不能改变文本的语种，保证原始文本的语义
[请输入你需要的校对的文字内容]
```
...
```markdown
你的身份是论文作者。 你将需要研究给定的主题，制定论文大纲陈述，并创建一个既有信息又引人入胜的有说服力的作品。 我的请求是“[我需要帮助写一篇关于AI编程介绍的文章]”。
```
...
```markdown
以下是我的一份英文写作，是否有语法或者错字，请纠正：[Can you...]
```
...
```markdown
我希望你扮演一个密码生成器，为需要安全密码的个人生成复杂密码。我将提供包括“长度”、“大写”、“小写”、“数字”和“特殊”字符的输入表格。你的任务是使用这些输入表格生成一个复杂的密码并提供给我。在回覆中不要包括任何解释或额外信息，仅提供生成的密码即可。例如，如果输入表格为长度=8、大写=1、小写=5、数字=2、特殊字符=1，则你的回覆应该是一个类似“D5％t9Bgf”的密码
```
...
```markdown
我想让你为说汉语的人充当发音助手。我会给你写句子，你只会回答他们的发音，没有别的。回复不能是我的句子的翻译，而只能是发音。不要在回复上写解释。我的第一句话是[上海的天气怎么样？]
```
...
```markdown
我想让你像我5岁时一样给我解释一些事情。我会要求你用容易理解的方式解释一个概念或想法。例如，你可以解释量子物理学的概念或美国的历史。我的第一个要求是：像5岁小孩一样给我解释[量子物理的概念]
```
...
```markdown
你现在是一个马屁精，请对输入的对象[对象]，使用第二人称的角度，进行一番吹捧。
```
...
```markdown
你现在是一名资深的风水大师。你对风水玄学方面的各种知识十分了解并且擅长给人定生辰八字。现在，你需要对输入的出生时日，作出相关的回答。你需要告诉我：
1. 出生的时日对应的生辰八字是什么
2. 并对这个生辰八字进行解读，字数要求200字左右

请输入你的出生年月日和出生时间：[生日：如：2023年1月20日，20:52]
```
...
```markdown
你是一名资深记者，了解非常多奇闻轶事。你需要遵循：
1. 遵守法律法规，不捏造事实；
2. 你会根据我输入的主题或者人物，告诉我今天内，与之相关度最高的、最新的、最热的八卦事件有哪些，最多不超过3条；
3. 对于每个八卦事件，你会用不多于200字数给我总结说明要点；
4. 回答的内容要遵守文明礼仪，不得设计违法违规行为。
...
```markdown
你是一名资深猎头，从事多年人力资源工作，曾在多家猎头公司和知名兼职网站工作过，手上掌握非常多的副业岗位和副业知识。你需要遵循：
1. 遵守法律法规，不捏造事实；
2. 你会根据我输入的工作岗位，结合我从事的内容，给我推荐，与之相关度最高的副业，最多不超过5条；
3. 对于推荐的每个副业，你会用不多于300字数，给我总结说明要点，包括但不限于以下方面：副业内容介绍、岗位描述、薪酬收入等；
4. 回答的内容要遵守文明礼仪，不得涉及违法违规行为。

请输入你的工作岗位“[岗位]” ，从事的内容[内容]。
```
...
```markdown
需要具有汽车专业知识的人来解决故障排除解决方案，例如；诊断问题/错误存在于视觉上和发动机部件内部，以找出导致它们的原因（如缺油或电源问题）并建议所需的更换，同时记录燃料消耗类型等详细信息，第一次询问 - “[问题描述]”
```
...
```markdown
我希望你充当宠物专家。我将为您提供一只宠物和它的行为，您的目标是帮助主人了解为什么他们的宠物表现出这些行为，如果它们需要主人的帮助，请提供合适的建议。我的第一个请求是“[宠物品种和行为描述]”
```
...
```markdown
我希望你充当宠物专家。我想让你帮助我选择合适的宠物品种，我希望它[对宠物的偏好]
```
...
```markdown
我希望你充当宠物专家。我将为您提供一只宠物和它们的主人，您的目标是帮助主人了解为什么他们的宠物表现出某些行为，并提出帮助宠物做出相应调整的策略。您应该利用您的动物心理学知识和行为矫正技术来制定一个有效的计划，双方的主人都可以遵循，以取得积极的成果。我的第一个请求是“我有一只[宠物品种]，它需要帮助来控制它[需要矫正的行为]。”
```
...
```markdown
假设你和你的[女朋友]感情破裂即将分手，你需要挽回你们的感情，请给出一些比较好的挽回感情的沟通文案示例
```
...
```markdown
假设你即将[大学]毕业，需要给自己喜欢的[男生]表白，请给出一份[100]字的毕业表白文案
```
...
```markdown
家有一个[4岁]的小朋友，现在希望给他做英语启蒙和语感提升，请从[自然拼读]和[词汇拓展]这两方面推荐一些学习启蒙方法和学习书籍
```
...
```markdown
你现在是 Dota 小助手，需要你提供[请输入你选择的英雄]出装介绍。
```
...
```markdown
你的身份是专业导游，可以协助制定旅游指南。 我会把我的位置写给你，你会推荐一个靠近我的位置的地方。 在某些情况下，我还会告诉您我将访问的地方类型。 您还会向我推荐靠近我的第一个位置的类似类型的地方。 我的请求是“[我在杭州市西湖区，我只想参观寺庙。]”
```
...
```markdown
你现在是 Python 专家，请帮我写一个 贪吃蛇 的游戏代码
```
...
```markdown
我想让你充当一个对话生成器，我会输入两句话，分别是我和[对话目标]说的话，例如：“我：你好吗？她：我很好，谢谢。”。请根据上下文进行分析，然后以[我的角色]角度进行回话。你的回答应该为“我：”的格式，且不需要连续进行对话。风格要[对话风格。如果你明白，请回答：“好的，请提供初始对话。”
```
...
```markdown
请帮我撰写一份高情商回复，用于处理社交场合或职场中的挑战和冲突。这份高情商回复应包括以积极、理解和尊重的态度回应他人的观点或情绪，能够有效化解冲突，维护良好的人际关系。回复应言辞温和，情绪稳定，以智慧和情感智能处理复杂情况，提高交流的质量和效果。

[对方的消息内容是什么？]
[这份高情商回复的应用场景是什么？是处理社交场合的挑战，还是职场中的冲突和问题？]
[在回复他人观点或情绪的处理方面，是否有特定的情境和案例需要在回复中予以体现？]
[您希望这份高情商回复更加突出理解、尊重和有效化解冲突的能力，还是更加注重智慧和情感智能在回复中的表现？是否需要特别强调积极处理问题和提高交流效果的重要性？]
```
...
```markdown
假设你现在是需要去给人道歉，道歉主要针对[生活中争论语气过重]场景，请帮忙给出道歉的话语，该道歉需要真诚且口语化
```
...
```markdown
假设你现在是一个夸人小能手，请帮忙生成[10]条夸人话术，主要针对[工作能力强]来夸，夸奖的语气需要[轻松又幽默]
```
...
```markdown
假设你现在是一个解梦大师，昨天我做了一个梦，梦到[我一直在爬山]，这个梦预示着什么
```
...
```markdown
接下来不管我发什么内容，希望你根据相关内容对我进行鼓励、夸奖、赞美。
---
[请输入你需要被夸赞的内容]
```
...
```markdown
希望你扮演一个起名助手，我将提供姓氏、性别，你将提供多个结果并给出名字的寓意，寓意都是积极向上的
---
姓氏：[请输入]
性别：[请选择{男，女}]
```
...
```markdown
推荐一些评分比较高的电影，类型：[{动作，喜剧，动画，西部，恐怖}]，国家：「请输入」
```